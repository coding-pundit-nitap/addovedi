      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 pt-20 pb-16">
        <section className="text-center mb-10">
          ...
          <p className="mt-3 text-sm sm:text-base text-[#94a3b8] max-w-2xl mx-auto">
            ...
            This edition embraces an RC Racing theme—celebrating hands‑on
            engineering, control systems, and the thrill of speed.
          </p>
        </section>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card className="border-[#050A18] bg-[#02050C]/90 backdrop-blur">
            <CardHeader>
              <CardTitle className="text-[#66FFFF]">
                What is Addovedi?
              </CardTitle>
            </CardHeader>
            <CardContent className="text-[#cbd5e1] text-sm leading-relaxed">
              Addovedi brings together students, innovators, and makers to
              build, compete, and learn. Expect a high‑energy mix of
              competitions, showcases, workshops, and community—powered by a
              neon, cyber‑racing aesthetic.
            </CardContent>
          </Card>

          <Card className="border-[#050A18] bg-[#02050C]/90 backdrop-blur">
            <CardHeader>
              <CardTitle className="text-[#B366FF]">
                This Year’s Theme: RC
              </CardTitle>
            </CardHeader>
            <CardContent className="text-[#cbd5e1] text-sm leading-relaxed">
              From RC track design and vehicle tuning to electronics, wireless
              control, and strategy— the festival spotlights the full stack of
              RC engineering with accessible, competitive events.
            </CardContent>
          </Card>
          ...
          <Card className="border-[#050A18] bg-[#02050C]/90 backdrop-blur">
            ...
            <CardContent className="text-[#cbd5e1] text-sm leading-relaxed">
              Join the races, volunteer with the crew, or support as a
              partner—there’s a pit lane for everyone.
            </CardContent>
          </Card>
        </div>
