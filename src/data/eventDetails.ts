...
const TBA: EventDetails = {
  teamSize: "TBA",
  prizeMoney: "TBA",
  registrationFee: "TBA",
  rules: ["TBA"],
  guidelines: ["TBA"],
  resultAnnouncement: "TBA",
  contact: "TBA",
};
...
export const eventDetails: Record<string, EventDetails> = {
  ...
  "nov6:Hackathon": {
    teamSize: "TBA",
    prizeMoney: "Price Pool Worth upto 50K",
    registrationFee: "TBA",
    rules: ["TBA"],
    guidelines: ["TBA"],
    resultAnnouncement: "TBA",
  ...
  "nov6:BGMI": {
    ...
    prizeMoney: "Prize Pool: ₹10,000 1st Place: ₹5,000 2nd Place: ₹3,000 3rd Place: ₹2,000",
    registrationFee: "TBA",
    rules: [
